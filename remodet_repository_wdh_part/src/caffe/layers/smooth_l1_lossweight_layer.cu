...
template <typename Dtype>
void SmoothL1LossWeightLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void SmoothL1LossWeightLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_LAYER_GPU_FUNCS(SmoothL1LossWeightLayer);
