#ifndef CAFFE_MASK_FACE_DATA_TRANSFORMER_HPP_
#define CAFFE_MASK_FACE_DATA_TRANSFORMER_HPP_
...
template <typename Dtype>
class FaceDataTransformer {
 public:
  // 构造函数
  explicit FaceDataTransformer(const UnifiedTransformationParameter& param, Phase phase)
      : param_(param), phase_(phase) { InitRand(); }
  virtual ~FaceDataTransformer() {}
