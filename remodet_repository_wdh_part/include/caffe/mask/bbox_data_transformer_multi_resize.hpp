#ifndef CAFFE_MASK_BBOX_DATA_MULTI_RESIZE_TRANSFORMER_HPP_
#define CAFFE_MASK_BBOX_DATA_MULTI_RESIZE_TRANSFORMER_HPP_
...
class BBoxDataMultiResizeTransformer {
 public:
  // 构造函数
  // 我们仍然使用UnifiedTransformationParameter进行构造
  explicit BBoxDataMultiResizeTransformer(const UnifiedTransformationParameter& param, Phase phase)
      : param_(param), phase_(phase) { InitRand(); }
  virtual ~BBoxDataMultiResizeTransformer() {}
