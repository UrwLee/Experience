#ifndef CAFFE_MASK_BBOX_DATA_MULTI_RESIZE_BATCH_TRANSFORMER_HPP_
#define CAFFE_MASK_BBOX_DATA_MULTI_RESIZE_BATCH_TRANSFORMER_HPP_
...
class BBoxDataMultiResizeBatchTransformer {
 public:
  // 构造函数
  // 我们仍然使用UnifiedTransformationParameter进行构造
  explicit BBoxDataMultiResizeBatchTransformer(const UnifiedTransformationParameter& param, Phase phase)
      : param_(param), phase_(phase) { InitRand(); }
  virtual ~BBoxDataMultiResizeBatchTransformer() {}
