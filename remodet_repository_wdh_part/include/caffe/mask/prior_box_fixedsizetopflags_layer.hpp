#ifndef CAFFE_PRIORBOX_FIXEDSIZETOPFLAGS_LAYER_HPP_
#define CAFFE_PRIORBOX_FIXEDSIZETOPFLAGS_LAYER_HPP_
...
class PriorBoxFixedSizeTopFlagsLayer : public Layer<Dtype> {
 public:

  explicit PriorBoxFixedSizeTopFlagsLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "PriorBoxFixedSizeTopFlags"; }
