#ifndef CAFFE_DETECTION_MULTIMC_OUTPUT_LAYER_HPP_
#define CAFFE_DETECTION_MULTIMC_OUTPUT_LAYER_HPP_
...
/**
 * 该层是基于YOLO/SSD的混合检测器，使用了YOLO的分类器设计方法以及SSD的回归方法。
 * 该方法不建议使用，请在阅读源码基础上使用。【该方法已停止更新】
 */

namespace caffe {

template <typename Dtype>
class DetectionMultiMcOutputLayer : public Layer<Dtype> {
 public:
  explicit DetectionMultiMcOutputLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
