#ifndef CAFFE_ROIS_RESIZE_LAYER_HPP_
#define CAFFE_ROIS_RESIZE_LAYER_HPP_
...
class RoiSResizeLayer : public Layer<Dtype> {
 public:
  explicit RoiSResizeLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "RoiSResize"; }
