...
class BaseConvolutionLayer : public Layer<Dtype> {
 ...
 protected:
  ...
  /// @brief The spatial dimensions of the stride.  步进
  Blob<int> stride_;
  /// @brief The spatial dimensions of the padding.
  Blob<int> pad_;
  /// @brief The spatial dimensions of the dilation. 扩张
  Blob<int> dilation_;
  ...
  int num_output_;
  bool bias_term_;
  bool is_1x1_; // 1x1 kernel, stride=1, pad=0
  ...
  inline void conv_im2col_cpu(const Dtype* data, Dtype* col_buff) {
    if (!force_nd_im2col_ && num_spatial_axes_ == 2) {
      im2col_cpu(data, conv_in_channels_,
          conv_input_shape_.cpu_data()[1], conv_input_shape_.cpu_data()[2], // conv_input_shape_[1]: H, conv_input_shape_[2]
