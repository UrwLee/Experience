...
class DataTransformer {
 public:
  ...
  void Transform(const AnnotatedDatum& anno_datum,
                 Blob<Dtype>* transformed_blob,
                 vector<AnnotationGroup>* transformed_anno_vec);
  void EasyTransform(const cv::Mat& cv_img,
      Blob<Dtype>* transformed_blob,
      bool* do_mirror);

  void NormTransform(const cv::Mat& cv_img,
                     Blob<Dtype>* transformed_blob,
                     const bool normalize, const vector<Dtype>& mean_value);
  ...
  bool TransformAnnotationOfPerson(
  ...
  /**
   * @brief Samples a crop-box
   */
  bool CropBoxSampler(const vector<AnnotationPart> &item_anno_part,
   ...
   */
  void TransformCvbyCBox(const cv::Mat& cv_img, Blob<Dtype>* transformed_blob,
