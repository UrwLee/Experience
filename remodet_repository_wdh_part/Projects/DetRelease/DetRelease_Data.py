...
if train_net_id == 1:
    train_list_bdpd169 = train_list_bdpd916=train_list_minihand
    root_dir_train_bdpd = train_root_minihand
    val_list_bdpd = val_list_minihand
    root_dir_val_bdpd = val_root_minihand
