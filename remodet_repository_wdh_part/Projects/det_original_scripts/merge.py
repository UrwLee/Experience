...
def merge(Base_network=BaseNet,Datasets=DataSets,Methods=DetMethod,Input_scale=InputScale,Model_level=ModelLevel):
	################################################################################
	# caffe根目录
	os.chdir(caffe_root)
	################################################################################
	...
	################################################################################
	save_work_dir = "{}/{}/Merge".format(work_dir,model_index)
	save_model_dir = "{}/Models".format(save_work_dir)
	save_snapshot_prefix = "{}/{}".format(save_model_dir,model_index)
