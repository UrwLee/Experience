...
def speed():
	...
	# 创建输入层
        ...
        net.data, net.orig_data = L.Videoframe(name="data", \
                              ...
                              ntop=2, **kwargs)
	# 创建网络
	pose_test_param = get_poseTestParam()
	net = mPoseNet_Decomp_3S_Test(net, from_layer="data", frame_layer="orig_data", use_bn=False, **pose_test_param)
	...
	with open(job_file, 'w') as f:
		...
		f.write('--layertest="{}" \\\n'.format(layer_test))
		if get_solver_mode() == P.Solver.GPU:
