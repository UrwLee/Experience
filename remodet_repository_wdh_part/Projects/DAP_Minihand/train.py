...
def DAPNet_Train():
	...
	# TRAIN
	net = caffe.NetSpec()
	net = get_MinihandDataLayer(net,train=True)
	# net = HandNet_DarkBase(net, train=True, data_layer="data", gt_label="label", \
	# 			 net_width=resized_width, net_height=resized_height)
	net = DAP_HandNet_MultiScale(net, train=True, data_layer="data", gt_label="label", \
					  net_width=resized_width, net_height=resized_height)
	...
	# TEST
	net = caffe.NetSpec()
	net = get_MinihandDataLayer(net,train=False)
	# net = HandNet_DarkBase(net, train=False, data_layer="data", gt_label="label", \
	# 			 net_width=resized_width, net_height=resized_height)
	net = DAP_HandNet_MultiScale(net, train=False, data_layer="data", gt_label="label", \
					  net_width=resized_width, net_height=resized_height)
