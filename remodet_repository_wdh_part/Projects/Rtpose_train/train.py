...
def rtpose_train():
	...
	net = mPoseNet_COCO_3S_Train(net, data_layer="data", label_layer="label", train=True, **pose_test_kwargs)
	...
	if not use_trainval:
		...
		pose_test_kwargs = get_poseTestParam()
		net = mPoseNet_COCO_3S_Train(net, data_layer="data", label_layer="label", train=False, **pose_test_kwargs)
