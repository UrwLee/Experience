...
if train_net_id == 0:
    ...
    root_dir_train_bdpd = ["/home/%s/SSD_DATA/Datasets/AIC_REMOCapture" % USERNAME,
                           "/home/%s/SSD_DATA/Datasets/RemoCoco" % USERNAME,
                           "/home/%s/SSD_DATA/Datasets/OtherBackGround_Images" % USERNAME]
val_list_bdpd = '/home/%s/Datasets/AIC_Data/Layout/val_PersonWithFaceHeadHand_V0_V0_cont1_V0_cont2_V0_cont3.txt' % USERNAME
root_dir_val_bdpd = '/home/%s/SSD_DATA/Datasets/AIC_Data' % USERNAME
...
if flag_miniresizeddata:
    train_root_minihand = ["/home/%s/SSD_DATA/Datasets/AIC_REMOCapture_resized"% USERNAME,
         "/home/%s/SSD_DATA/Datasets/RemoCoco_resized"% USERNAME,
         "/home/%s/SSD_DATA/Datasets/OtherBackGround_Images_resized"% USERNAME]
else:
    train_root_minihand = ["/home/%s/SSD_DATA/Datasets/AIC_REMOCapture" % USERNAME,
                           "/home/%s/SSD_DATA/Datasets/RemoCoco" % USERNAME,
                           "/home/%s/SSD_DATA/Datasets/OtherBackGround_Images" % USERNAME]
val_list_minihand = '/home/%s/Datasets/AIC_Data/Layout/val_PersonWithFaceHeadHand_V0_V0_cont1_V0_cont2_V0_cont3.txt' % USERNAME
val_root_minihand = '/home/%s/SSD_DATA/Datasets/AIC_Data' % USERNAME
######Pose Estimation Data
root_dir_pose = '/home/%s/SSD_DATA/PoseDatasets/'%USERNAME
train_lists_pose = "/home/%s/PoseDatasets/Layout/trainval_Google20180817Coco.txt"% USERNAME
val_lists_pose = "/home/%s/PoseDatasets/Layout/val15.txt"% USERNAME
