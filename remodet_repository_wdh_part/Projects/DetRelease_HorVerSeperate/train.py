...
def DAPNet_Train():
	...
	if train_net_id == 0:
		...
		if flag_mininetwithface:
			net = DetRelease_SecondPartAllNetMiniHandFace(train=True)
		else:
			if flag_handfacetwoboxloss:
				net = DetRelease_SecondPartHandFaceTwoSeperateBBoxLoss(train=True)
			else:
	...
	if train_net_id == 0:
		...
		if flag_mininetwithface:
			net = DetRelease_SecondPartAllNetMiniHandFace(train=False)
		else:
			if flag_handfacetwoboxloss:
				net = DetRelease_SecondPartHandFaceTwoSeperateBBoxLoss(train=False)
			else:
