...
train_list = '/home/%s/data/WiderFace/Layout/train.txt' % USERNAME
val_list = '/home/%s/data/WiderFace/Layout/val.txt' % USERNAME
root_dir = '/home/%s/data/WiderFace' % USERNAME
save_dir = '/home/%s/data/WiderFace/vis_aug' % USERNAME
