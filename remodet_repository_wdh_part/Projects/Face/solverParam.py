...
from FaceNet import *
from ssdParam import *
# #################################################################################
caffe_root = "/home/{}/work/face_repository".format(USERNAME)
# --------------------------------Model Info--------------------------------------
Project = "FaceDet"
BaseNet = "ResPose"
Models = "WiderFace"
...
Init.
"""
Pretained_Model = "/home/zhangming/Models/Release/release1005/ResPose_WiderFace_V1_iter_14195.caffemodel"
...
update_batchsize = 1 * batchsize_1080
test_batchsize = 1
