...
ssd_Param = {
    ...
    'multilayers_aspect_ratios': [[[0.5],[0.5]],[[0.5],[0.5],[0.5]],[[1,0.5,0.25],[1,0.5,0.25],[1,0.5,0.25],[1]]],
    'num_classes': 2,
    ...
    'multiloss_size_threshold': 0.0000,
    ...
    'detectioneval_boxsize_threshold': [0, 0.0025, 0.005, 0.01, 0.05, 0.1, 0.2],
