...
########################################################################################################
# 数据文件
train_list = ['/home/ethan/PoseDatasets/Layout/trainval_SinglePerson_RemoveBoxWorHLE30.txt']
val_list = '/home/ethan/PoseDatasets/Layout/trainval_SinglePerson.txt'
# 图像路径
root_dir_train = ['/home/ethan/PoseDatasets']
root_dir_val = '/home/ethan/PoseDatasets'
...
def getHPDataLayer(net, train=True):
    ...
    net.data, net.label = L.BBoxDataSinglePersonPose(name="data", unified_data_param=hpkeypoint_data_param, unified_data_transform_param=trans_param, ntop=2, **kwargs)
    return net
