...
MpiiImageLoader<Dtype>::MpiiImageLoader(const std::string& image_folder, const std::string& xml_folder) {
...
template <typename Dtype>
bool MpiiImageLoader<Dtype>::LoadAnnotationFromXmlFile(const string& annotation_file, const string& image_path,
                                                MetaData<Dtype>* meta) {
  ptree pt;
...
INSTANTIATE_CLASS(MpiiImageLoader);
}
