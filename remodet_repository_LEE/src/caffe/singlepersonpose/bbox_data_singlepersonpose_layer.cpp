...
#include "caffe/singlepersonpose/bbox_data_singlepersonpose_layer.hpp"
...
BBoxDataSinglePersonPoseLayer<Dtype>::~BBoxDataSinglePersonPoseLayer<Dtype>() {
  this->StopInternalThread();
}

template <typename Dtype>
void BBoxDataSinglePersonPoseLayer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  bbox_data_transformer_.reset(
     new BBoxDataSinglePersonPoseTransformer<Dtype>(bbox_data_transform_param_, this->phase_));
  // 获取数据Layer参数
...
template <typename Dtype>
void BBoxDataSinglePersonPoseLayer<Dtype>::ShuffleLists() {
...
template <typename Dtype>
void BBoxDataSinglePersonPoseLayer<Dtype>::load_batch(Batch<Dtype>* batch) {
...
template <typename Dtype>
void BBoxDataSinglePersonPoseLayer<Dtype>::ReadAnnoDataFromXml(const int bindex, const string& xml_file, const string& root_dir,
                                                  AnnoData<Dtype>* anno) {
  ptree pt;
...
INSTANTIATE_CLASS(BBoxDataSinglePersonPoseLayer);
REGISTER_LAYER_CLASS(BBoxDataSinglePersonPose);
}  // namespace caffe
