...
#include "caffe/mask/prior_box_fixedsize_layer.hpp"

namespace caffe {

template <typename Dtype>
void PriorBoxFixedSizeLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype> *> &bottom,
...
template <typename Dtype>
void PriorBoxFixedSizeLayer<Dtype>::Reshape(const vector<Blob<Dtype> *> &bottom,
                                   const vector<Blob<Dtype> *> &top) {
...
template <typename Dtype>
void PriorBoxFixedSizeLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype> *> &bottom,
                                       const vector<Blob<Dtype> *> &top) {
...
INSTANTIATE_CLASS(PriorBoxFixedSizeLayer);
REGISTER_LAYER_CLASS(PriorBoxFixedSize);
