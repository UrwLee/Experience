#ifndef CAFFE_POSE_COCO_IMAGE_LOADER_H
#define CAFFE_POSE_COCO_IMAGE_LOADER_H
...
class CocoImageLoader : public PoseImageLoader<Dtype> {
public:
  /**
   * 构造：
   ...
   * 读取XML文件目录下的所有XML文件
   */
  CocoImageLoader(const std::string& image_folder, const std::string& xml_folder);
