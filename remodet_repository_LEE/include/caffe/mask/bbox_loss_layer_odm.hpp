#ifndef CAFFE_MASK_BBOX_LOSS_ODM_LAYER_HPP_
#define CAFFE_MASK_BBOX_LOSS_ODM_LAYER_HPP_
...
class BBoxLossODMLayer : public LossLayer<Dtype> {
 public:
  explicit BBoxLossODMLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "BBoxLossODM"; }
