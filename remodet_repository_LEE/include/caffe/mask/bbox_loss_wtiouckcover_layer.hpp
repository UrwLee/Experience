#ifndef CAFFE_MASK_BBOX_LOSS_WTIOUCKOUVER_LAYER_HPP_
#define CAFFE_MASK_BBOX_LOSS_WTIOUCKOUVER_LAYER_HPP_
...
class BBoxLossWTIOUCKCOVERLayer : public LossLayer<Dtype> {
 public:
  explicit BBoxLossWTIOUCKCOVERLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "BBoxLossWTIOUCKCOVER"; }
 ...
 protected:
  ...
  bool using_GHMC_loss_;  // default: False
  int m_;               // if use FocusLoss, define the gama-parameter
