#ifndef CAFFE_MASK_BBOX_LOSS_LAYER_SOFTMAX_HPP_
#define CAFFE_MASK_BBOX_LOSS_LAYER_SOFTMAX_HPP_
...
class BBoxLossSoftmaxLayer : public LossLayer<Dtype> {
 public:
  explicit BBoxLossSoftmaxLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "BBoxLossSoftmax"; }
