#ifndef CAFFE_MASK_RPNALIKEBEFORENMS_DET_OUT_LAYER_HPP_
#define CAFFE_MASK_RPNALIKEBEFORENMS_DET_OUT_LAYER_HPP_
...
class RPNAlikeDetOutBeforeNMSLayer : public Layer<Dtype> {
 public:
  explicit RPNAlikeDetOutBeforeNMSLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "RPNAlikeDetOutBeforeNMS"; }
  /**
