#ifndef CAFFE_PRIORBOX_FIXEDSIZE_LAYER_HPP_
#define CAFFE_PRIORBOX_FIXEDSIZE_LAYER_HPP_
...
class PriorBoxFixedSizeLayer : public Layer<Dtype> {
 public:

  explicit PriorBoxFixedSizeLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "PriorBoxFixedSize"; }
