...
class MatchAnchorGtLayer(caffe.Layer):
    """
    ...
    def setup(self, bottom, top):
        ...
        print self._num_anchors,num_anchors
    ...
    def forward(self, bottom, top):
        ...
        #     print anchors[i]
        #     raw_input()
        match_gts = np.zeros((self._batchsize,self._num_anchors))
        ...
        pos_batch_ids,pos_anchor_ids = np.where(labels==1)
        pos_match = np.zeros((len(pos_anchor_ids),4))
        pos_match[:,0] = pos_batch_ids
        pos_match[:, 1] = pos_anchor_ids
        pos_match[:, 3] = match_gts[pos_batch_ids, pos_anchor_ids]
