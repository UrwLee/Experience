...
keypoint_proto = "/home/ethan/Models/Results/HPKeypoint/CNN32CFive64C_scale4_3stagesheatvec_MinS1.5MaxS1.6_Sigma5RT90_MoreIter_1A_3stage.prototxt"
keypont_weights = "/home/ethan/Models/Results/HPKeypoint/CNN32CFive64C_scale4_3stagesheatvec_MinS1.5MaxS1.6_Sigma5RT90_MoreIter_1A_iter_200000.caffemodel"
...
while(True):
	...
	for i in xrange(len(hand_boxes_org)):
		...
		w_box = xmax - xmin
		h_box = ymax - ymin
		xmin = max(0,xmin - s*w_box)
		xmax = min(512,xmax + s * w_box)
		ymin = max(0, ymin - s * h_box)
		ymax = min(288, ymax + s*h_box)
