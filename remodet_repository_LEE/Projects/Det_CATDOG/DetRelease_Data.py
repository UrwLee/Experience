...
if train_net_id == 0:
    train_list_bdpd169 = ['/home/%s/Datasets/COCO_ori/Layout/COCO2017_CATDOG_TRAIN.txt'% USERNAME]
    root_dir_train_bdpd = ['/home/%s/Datasets/COCO_ori' % USERNAME]
...
val_list_bdpd = '/home/%s/Datasets/COCO_ori/Layout/COCO2017_CATDOG_VAL.txt' % USERNAME
root_dir_val_bdpd = '/home/%s/Datasets/COCO_ori' % USERNAME
...
val_root_minihand = '/home/%s/Datasets/AIC_Data' % USERNAME
######Pose Estimation Data
root_dir_pose = '/home/%s/PoseDatasets/'%USERNAME
