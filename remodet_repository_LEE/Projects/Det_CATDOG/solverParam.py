...
# #################################################################################
caffe_root = "/home/{}/work/remodet_repository_LEE".format(USERNAME)
# --------------------------------Model Info--------------------------------------
trunc_ratio = 1.0
...
# --------------------------------solver Param-----------------------------------
batchsize_1050 = 1
batchsize_per_device = batch_size
update_batchsize = 2 * batch_size
test_batchsize = 1
...
# get update iters
def get_update_iter():
    return int(math.ceil(float(update_batchsize) / (batch_size * get_gpunums())))
