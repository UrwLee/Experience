...
ssd_2_gt_labels = [1,3] # head and face
...
ssd_Param_1 = {
    # FeatureLayers
    'feature_layers': ['feat4','feat5','conv6_5'],
    # num_classes
    ...
    #                            [1,0.5],        \
    #                            [1]]],
    'anchor_boxsizes': [[[0.04,0.071],[0.08, 0.142]],
                       [[0.16, 0.284],[0.3125,0.5555]],
                       [[0.5,0.8889],[0.625,1]]],
    'anchor_aspect_ratios': [[[2,1,0.5],[2,1,0.5]], \
                             [[2,1,0.5],[2,1,0.5]], \
                             [[2,1,0.5],[2,1]]],
    ...
    'interlayers_channels_kernels': [[[128,1],[128,3]],\
                                     [[128,1],[128,3]],\
                                     [[128,1],[128,3]],],
...
# 'feature_layers': ['conv2_1_recon_relu','featuremap1','featuremap2','featuremap3'],
    ...
    #                          ],
    'anchor_boxsizes': [[[0.02344,0.04167],[0.04688,0.0833],[0.09375, 0.1667],[0.1875, 0.3333]],
                        [[0.25, 0.4444],[0.375,0.6667]],
                        [[0.4453,0.7917],[0.625,0.9375]]],
    'anchor_aspect_ratios': [[[1],[1],[1],[1]], \
                             [[1],[1]], \
                             [[1],[1]]],
