...
def DAPNet_Train():
	...
	net = DAPNetVGGDark(net, train=True, data_layer="data", gt_label="label",\
	...
	net= mPoseNet_VGGDarkNet_Train(net, data_layer="data_pose", label_layer="label_pose", train=True, **pose_test_kwargs)
	...
	net = DAPNetVGGDark(net, train=False, data_layer="data", gt_label="label", \
				net_width=resized_width, net_height=resized_height)
	#pose
	net = get_poseDataLayer(net,train=False)
	pose_test_kwargs = get_poseTestParam()
	net = mPoseNet_VGGDarkNet_Train(net, data_layer="data_pose", label_layer="label_pose", train=False, **pose_test_kwargs)
